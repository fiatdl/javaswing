...
public class danhsachhoadon extends javax.swing.JFrame {
    ...
    public danhsachhoadon() {
        initComponents();
               List<suachua> ls=new ArrayList<suachua>();
        ls=dao.getall();
        DefaultTableModel model =(DefaultTableModel)jTable1.getModel();
        for(int i=0;i<ls.size();i++){
            suachua x = ls.get(i);
            String tennv=stdao.getstbyId(x.getManv()).getHoten();
            String dv=dvdao.getstbyId(x.getMadv()).getTendvString();
            model.addRow(new Object[]{x.getMascString(),tennv,dv,x.getGias()+x.getChiphisuaxe()});
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "mã sửa chữa", "nhân viên sửa chữa", "dịch vụ sửa chữa", "tổng chi phí"
            }
        ) {
