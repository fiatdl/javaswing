...
public class dichvuframe extends javax.swing.JFrame {
    ...
    public dichvuframe() {
        initComponents();
        List<dichvu> ls=new ArrayList<dichvu>();
        ls=dao.getall();
        DefaultTableModel model =(DefaultTableModel)dichvuTable.getModel();
        for(int i=0;i<ls.size();i++){
            dichvu x = ls.get(i);
            model.addRow(new Object[]{i,x.getMadv(),x.getTendvString(),x.getGia()});
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thông tin các dịch vụ sửa xe");
        ...
        dichvuTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "stt", "mã dịch vụ", "Tên dịch vụ", "Giá Thành"
            }
        ) {
